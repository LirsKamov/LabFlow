    ...
    <SafeAreaView className="flex-1 bg-gray-50" edges={["top"]}>
      ...
      >
        ...
        <View className="h-6" />
            ...
            <Text className="text-gray-600 text-sm mb-1">母液浓度 C₁</Text>
            <TextInput
              className="input-field mb-3"
              placeholder="如 10 (任意单位)"
              value={stockConc}
              onChangeText={setStockConc}
              keyboardType="decimal-pad"
            />
            <Text className="text-gray-600 text-sm mb-1">目标浓度 C₂</Text>
            <TextInput
              className="input-field mb-3"
              placeholder="如 1"
              value={targetConc}
              onChangeText={setTargetConc}
              keyboardType="decimal-pad"
            />
            <Text className="text-gray-600 text-sm mb-1">目标体积 V₂</Text>
            <TextInput
              className="input-field mb-4"
              placeholder="如 100 (mL/μL)"
              value={targetVol}
            ...
            <TouchableOpacity
              ...
              onPress={handleCalc}
            >
              <Text className="btn-primary-text">计算</Text>
            </TouchableOpacity>
            {dilutionResult && (
              <View className="mt-4 bg-blue-50 rounded-xl p-4">
                <Text className="text-blue-800 font-semibold">
                  母液用量：{dilutionResult.stockVolume} (体积单位)
                </Text>
                <Text className="text-blue-600 text-sm mt-1">
                  溶剂用量：{dilutionResult.solventVolume} (体积单位)
                </Text>
              </View>
            )}
          </View>
        ...
        return (
          <View className="bg-white rounded-2xl p-5 mt-4">
            ...
            <Text className="text-gray-500 text-sm mb-4">
              Tm = 2°C × (A+T) + 4°C × (G+C)  ·  适用于 &lt;20 bp 引物
            </Text>
            <Text className="text-gray-600 text-sm mb-1">引物序列</Text>
            <TextInput
              className="input-field mb-4"
              placeholder="如 ATCGATCGATCG"
              value={tmSeq}
              onChangeText={(t) => setTmSeq(t.toUpperCase())}
      ...
      case "gc":
        return (
          <View className="bg-white rounded-2xl p-5 mt-4">
            ...
            <Text className="text-gray-600 text-sm mb-1">序列</Text>
            <TextInput
              className="input-field mb-4"
              placeholder="如 ATCGATCG"
              value={gcSeq}
              onChangeText={(t) => setGcSeq(t.toUpperCase())}
              autoCapitalize="characters"
            />
            <TouchableOpacity
              className="btn-primary"
      ...
      case "cell":
        return (
          <View className="bg-white rounded-2xl p-5 mt-4">
            ...
            <Text className="text-gray-600 text-sm mb-1">稀释倍数</Text>
            <TextInput
              className="input-field mb-3"
              placeholder="如 2"
              value={cellDilution}
              onChangeText={setCellDilution}
              keyboardType="decimal-pad"
            />
            <Text className="text-gray-600 text-sm mb-1">悬液体积 (mL)</Text>
            <TextInput
              className="input-field mb-4"
              placeholder="如 1"
              value={cellVolume}
            ...
            {cellResult && (
              <View className="mt-4 bg-green-50 rounded-xl p-4">
                <Text className="text-green-800 font-semibold">
                  浓度：{cellResult.concentration.toLocaleString()} cells/mL
                </Text>
                <Text className="text-green-600 text-sm mt-1">
                  总细胞数：{cellResult.totalCells.toLocaleString()} cells
                </Text>
              </View>
            )}
          </View>
            ...
            {statsResult && (
              <View className="mt-4 bg-blue-50 rounded-xl p-4">
                <Text className="text-blue-800">
                  均值：{statsResult.mean.toFixed(4)}
                </Text>
                <Text className="text-blue-800 mt-1">
                  标准差 (SD)：{statsResult.stdDev.toFixed(4)}
                </Text>
                <Text className="text-blue-800 mt-1">
                  变异系数 (CV)：{statsResult.cv}%
                </Text>
              </View>
            )}
          </View>
      ...
      case "protein":
        return (
          <View className="bg-white rounded-2xl p-5 mt-4">
            ...
            <Text className="text-gray-600 text-sm mb-1">样品吸光度</Text>
            <TextInput
              className="input-field mb-3"
              placeholder="如 0.45"
              value={proteinAbs}
              onChangeText={setProteinAbs}
              keyboardType="decimal-pad"
            />
            <Text className="text-gray-600 text-sm mb-1">标准曲线斜率</Text>
            <TextInput
              className="input-field mb-3"
              placeholder="如 0.02"
              value={proteinSlope}
              onChangeText={setProteinSlope}
              keyboardType="decimal-pad"
            />
            <Text className="text-gray-600 text-sm mb-1">标准曲线截距</Text>
            <TextInput
              className="input-field mb-3"
              placeholder="如 0.05"
              value={proteinIntercept}
              onChangeText={setProteinIntercept}
              keyboardType="decimal-pad"
            />
            <Text className="text-gray-600 text-sm mb-1">稀释倍数</Text>
            <TextInput
              className="input-field mb-4"
              placeholder="如 1 (未稀释)"
              value={proteinDilution}
              onChangeText={setProteinDilution}
              keyboardType="decimal-pad"
            />
            <TouchableOpacity
              className="btn-primary"
            ...
            {proteinResult !== null && (
              <View className="mt-4 bg-purple-50 rounded-xl p-4">
                <Text className="text-purple-800 font-semibold">
                  蛋白浓度：{proteinResult.toFixed(3)} μg/μL (mg/mL)
                </Text>
              </View>
            )}
          </View>
  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50" edges={["top"]}>
      <View className="bg-white px-5 pt-4 pb-4 border-b border-gray-200">
        <Text className="text-2xl font-bold text-gray-800">计算工具</Text>
          ...
          <View className="flex-row flex-wrap -mx-1.5">
            {TOOLS.map((tool) => (
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <View className="bg-white rounded-2xl p-4 h-32 justify-center border border-gray-100">
        ...
        {activeTool && (
          <View>
            ...
            >
              ...
              <Text className="text-primary-600 font-medium ml-1">返回工具列表</Text>
            </TouchableOpacity>
            {renderToolForm()}
          </View>
        )}
